    ...
    <div className={`relative min-h-screen ${pageBg(darkMode)}`}>
      ...
      <div className="hidden md:flex relative px-6 md:px-12 lg:px-20 xl:px-28 2xl:px-36 flex-row items-center justify-center min-h-[calc(100vh-64px)]">
        <div className="flex flex-col justify-center w-1/3 pr-6 z-10">
          <div className="max-w-md">
            <h1 className={`font-heading mb-4 leading-snug drop-shadow-lg text-[clamp(2rem,5vw,5rem)] ${primaryText(darkMode)}`}>
              PlantMate+
            </h1>

            <p className={`font-sans mb-3 leading-relaxed drop-shadow-md text-[clamp(0.875rem,2vw,1.25rem)] ${primaryText(darkMode)}`}>
              PlantMate matches you with plants that fit your lifestyle, personality, and home. No guilt. No guesswork. Just plants you'll actually keep alive.
            </p>

            <p className={`font-sans mb-6 leading-relaxed drop-shadow-md text-[clamp(0.875rem,2vw,1.25rem)] ${primaryText(darkMode)}`}>
        ...
        <div className="flex-1 flex justify-end items-end z-0 pointer-events-none">
          <img
            src={darkMode ? "/images/desktop-images/plants-dark-mode.svg" : "/images/desktop-images/plants-light-mode.svg"}
            alt="Plants"
      ...
      <div className="md:hidden relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        ...
        <p className="font-sans text-lg sm:text-xl lg:text-2xl mb-8 text-white">
          PlantMate matches you with plants that fit your lifestyle, personality, and home. No guilt. No guesswork. Just plants you'll actually keep alive. Take our quick quiz and meet your perfect plant match.
        </p>
      </div>

      <div className="block md:hidden absolute bottom-0 left-0 right-0">
        <img
          src={darkMode ? "/images/mobile-images/plant-dark-mobile.svg" : "/images/mobile-images/plant-light-mobile.svg"}
          alt="Plants"
